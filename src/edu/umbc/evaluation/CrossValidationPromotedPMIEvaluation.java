...
public class CrossValidationPromotedPMIEvaluation {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length > 0){
			...
			if (args[0].equals("VB")){
				test = new CrossValidationPromotedPMIEvaluation(dataPath+"/evaluation/verbSynonyms700.txt", "VB");
				totalEntries = 1187;
				
			}else if (args[0].equals("NN")){
				test = new CrossValidationPromotedPMIEvaluation(dataPath+"/evaluation/nounSynonyms700.txt", "NN");
				totalEntries = 2286;
				
			}else if (args[0].equals("JJ")){
				test = new CrossValidationPromotedPMIEvaluation(dataPath+"/evaluation/adjSynonyms700.txt", "JJ");
				totalEntries = 1015;
				
			}else if (args[0].equals("RB")){
				test = new CrossValidationPromotedPMIEvaluation(dataPath+"/evaluation/advSynonyms700.txt", "RB");
				totalEntries = 39;
			}else{
