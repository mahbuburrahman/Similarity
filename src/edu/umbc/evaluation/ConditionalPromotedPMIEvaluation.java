...
public class ConditionalPromotedPMIEvaluation {
	...
	public ConditionalPromotedPMIEvaluation(String InfileName, String pos) {
		...
		try{
			...
			statPrecisionAllOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_condi_pr_all.txt"));
			statPrecision1SenseOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_condi_pr_1sense.txt"));
			statPrecision1SynonymOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_condi_pr_1synonym.txt"));
			
			statRecallAllOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_condi_re_all.txt"));
			statRecall1SenseOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_condi_re_1sense.txt"));
			statRecall1SynonymOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_condi_re_1synonym.txt"));
	...
	public void getStatisticForAllSenses() throws IOException{
		...
		statRecallAllOut.println(model.CONDITIONAL_THRESHOLD + "\t" + sumOfRecall10/numberOfEntries + "\t" + sumOfRecall25/numberOfEntries + "\t" + sumOfRecall50/numberOfEntries 
				+ "\t" + sumOfRecall100/numberOfEntries + "\t" + sumOfRecall200/numberOfEntries + "\t" + sumOfRecall500/numberOfEntries);
		
		statPrecisionAllOut.println(model.CONDITIONAL_THRESHOLD + "\t" + sumOfRanks10/numOfRanks10 + "\t" + sumOfRanks25/numOfRanks25 + "\t" + sumOfRanks50/numOfRanks50 + "\t" 
	...
	public void getStatisticForTheOnlySense() throws IOException{
		...
		statRecall1SenseOut.println(model.CONDITIONAL_THRESHOLD + "\t" + sumOfRecall10/numberOfEntries + "\t" + sumOfRecall25/numberOfEntries + "\t" + sumOfRecall50/numberOfEntries 
				+ "\t" + sumOfRecall100/numberOfEntries + "\t" + sumOfRecall200/numberOfEntries + "\t" + sumOfRecall500/numberOfEntries);
		
		statPrecision1SenseOut.println(model.CONDITIONAL_THRESHOLD + "\t" + sumOfRanks10/numOfRanks10 + "\t" + sumOfRanks25/numOfRanks25 + "\t" + sumOfRanks50/numOfRanks50 + "\t" 
				+ sumOfRanks100/numOfRanks100 + "\t" + sumOfRanks200/numOfRanks200 + "\t" + sumOfRanks500/numOfRanks500);
	...
	public void getStatisticForFirstSynonymInTheOnlySense() throws IOException{
		...
		statRecall1SynonymOut.println(model.CONDITIONAL_THRESHOLD + "\t" + sumOfRecall10/numberOfEntries + "\t" + sumOfRecall25/numberOfEntries + "\t" + sumOfRecall50/numberOfEntries 
				+ "\t" + sumOfRecall100/numberOfEntries + "\t" + sumOfRecall200/numberOfEntries + "\t" + sumOfRecall500/numberOfEntries);
		
		statPrecision1SynonymOut.println(model.CONDITIONAL_THRESHOLD + "\t" + sumOfRanks10/numOfRanks10 + "\t" + sumOfRanks25/numOfRanks25 + "\t" + sumOfRanks50/numOfRanks50 + "\t" 
				+ sumOfRanks100/numOfRanks100 + "\t" + sumOfRanks200/numOfRanks200 + "\t" + sumOfRanks500/numOfRanks500);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < 8; i++){
			...
			if (i==0)
				test.model.CONDITIONAL_THRESHOLD = 0;
			else if (i==1)
				test.model.CONDITIONAL_THRESHOLD = (double) 1 / 5000;
			else if (i==2)
				test.model.CONDITIONAL_THRESHOLD = (double) 1 / 2000;
			else if (i==3)
				test.model.CONDITIONAL_THRESHOLD = (double) 1 / 1000;
			else if (i==4)
				test.model.CONDITIONAL_THRESHOLD = (double) 1 / 800;
			else if (i==5)
				test.model.CONDITIONAL_THRESHOLD = (double) 1 / 500;
			else if (i==6)
				test.model.CONDITIONAL_THRESHOLD = (double) 1 / 300;
			else if (i==7)
				test.model.CONDITIONAL_THRESHOLD = (double) 1 / 200;
			...
			System.out.println(test.model.CONDITIONAL_THRESHOLD + " is done.");
		}
