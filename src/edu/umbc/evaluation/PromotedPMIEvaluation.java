...
public class PromotedPMIEvaluation {
	...
	public PromotedPMIEvaluation(String InfileName, String pos) {
	...
	public static void main(String[] args) throws Exception {
		...
		PromotedPMIEvaluation test;
		int totalEntries;
		
		if (args.length > 0){
			
			if (args[0].equals("VB")){
				test = new PromotedPMIEvaluation(dataPath+"/evaluation/verbSynonyms700.txt", "VB");
				totalEntries = 1187;
				
			}else if (args[0].equals("NN")){
				test = new PromotedPMIEvaluation(dataPath+"/evaluation/nounSynonyms700.txt", "NN");
				totalEntries = 2286;
				
			}else if (args[0].equals("JJ")){
				test = new PromotedPMIEvaluation(dataPath+"/evaluation/adjSynonyms700.txt", "JJ");
				totalEntries = 1015;
				
			}else if (args[0].equals("RB")){
				test = new PromotedPMIEvaluation(dataPath+"/evaluation/advSynonyms700.txt", "RB");
				totalEntries = 39;
			}else{
			...
			test = new PromotedPMIEvaluation(dataPath+"/evaluation/nounSynonyms700_2000.txt", "NN");
			//totalEntries = 2286;
		}
