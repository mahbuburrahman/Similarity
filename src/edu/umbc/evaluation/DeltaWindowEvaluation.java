...
public class DeltaWindowEvaluation {
	...
	public DeltaWindowEvaluation(String InfileName, String pos) {
		...
		try{
			...
			statPrecisionAllOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_delta_pr_all.txt"));
			statPrecision1SenseOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_delta_pr_1sense.txt"));
			statPrecision1SynonymOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_delta_pr_1synonym.txt"));
			
			statRecallAllOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_delta_re_all.txt"));
			statRecall1SenseOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_delta_re_1sense.txt"));
			statRecall1SynonymOut = new PrintWriter(new FileWriter(infileName.substring(0, infileName.length() - 4) + "_delta_re_1synonym.txt"));
	...
	public void set(String modelname, int p_size, int freThreshold, double conThreshold){
		...
		size = p_size;
		model = new CoOccurModelByArrays(modelname, false, freThreshold, conThreshold);
