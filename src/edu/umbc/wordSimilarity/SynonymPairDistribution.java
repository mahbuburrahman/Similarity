...
public class SynonymPairDistribution {
	...
	public void output() throws IOException{
		...
		outputFile = new FileWriter("noun_pairs.csv");
		distributionOutput = new PrintWriter(new BufferedWriter(outputFile));
		...
		outputFile = new FileWriter("verb_pairs.csv");
		distributionOutput = new PrintWriter(new BufferedWriter(outputFile));
		...
		outputFile = new FileWriter("adj_pairs.csv");
		distributionOutput = new PrintWriter(new BufferedWriter(outputFile));
		...
		outputFile = new FileWriter("adv_pairs.csv");
		distributionOutput = new PrintWriter(new BufferedWriter(outputFile));
