...
public class WindowScanByLingpipePOS {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			test = new WindowScanByParaAndPOS(20, dataPath+"/model/Gutenberg2010/stopwords", dataPath+"/test/corpus/test", 
			...
			*/
			...
			if (args.length == 3){
				...
				test = new WindowScanByLingpipePOS(size, dataPath+"/model/Gutenberg2010pos/stopwords", dataPath+"/Gutenberg2010Books", 
						dataPath+"/model/Gutenberg2010pos/Gutenberg2010AllW" + (size + 1), args[1], args[2]);
				test.run();
			}else {
